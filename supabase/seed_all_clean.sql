-- ====================================================================
-- DATABASE SCHEMA & DỮ LIỆU CHUẨN SGK VẬT LÍ 12 (KẾT NỐI TRI THỨC)
...
-- 5. BƯỚC 1: NẠP 4 CHƯƠNG SGK VẬT LÍ 12
...
-- 6. BƯỚC 2: NẠP CÁC BÀI HỌC DÙNG TRỰC TIẾP ID CHƯƠNG ĐẢM BẢO 100% KHÔNG LỖI KHÓA NGOẠI
...
-- 7. BƯỚC 3: NẠP 16 CÂU HỎI 4 CHỦ ĐỀ
